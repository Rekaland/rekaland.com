...
const propertySchema = z.object({
  ...
  address: z.string().optional().min(1, "Alamat Lengkap wajib diisi"),
  land_size: z.coerce.number().min(1, "Luas Tanah wajib diisi").optional(),
  building_size: z.coerce.number().min(1, "Luas Bangunan wajib diisi").optional(),
